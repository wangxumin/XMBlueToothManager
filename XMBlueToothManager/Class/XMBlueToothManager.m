...
#import "XMBlueToothManager.h"

#define WEAKSELF typeof(self) __weak weakSelf = self;

@interface XMBlueToothManager()

@property (nonatomic , strong) BabyRhythm *rhythm;

@property (nonatomic , copy) XMPeripheralsBlock peripheralsBlock;
@property (nonatomic , copy) XMDiscoverServices serviceBlock;
@property (nonatomic , copy) XMDiscoverCharacteristics characteristicBlock;
@property (nonatomic , copy) XMReadValueForCharacteristic readValueForCharacteristic;
@property (nonatomic , copy) XMDiscoverDescriptorsForCharacteristic discoverDescForCharacter;
@property (nonatomic , copy) XMReadValueForDescriptors descriptorsValue;
@property (nonatomic , copy) XMsetFilterOnDiscoverPeripherals setFilterOnDiscoverPeripherals;
@property (nonatomic , copy) XMConnectStateBlock connectState; //连接状态
@property (nonatomic , copy) XMDisconnectAtChannel disconnectBlock;
@property (nonatomic , copy) XMDiscoverServicesAtChannel discoverServicesBlock;
@property (nonatomic , copy) XMDiscoverCharacteristicsAtChannel discoverCharacteristicsBlock;
@property (nonatomic , copy) XMReadValueForCharacteristicAtChannel readValueForCharacter;
@property (nonatomic , copy) XMDiscoverDescriptorsForCharacteristicAtChannel channelDesForCharac;
@property (nonatomic , copy) XMReadValueForDescriptorsAtChannel readValueForDesAtChannel;
@property (nonatomic , copy) XMReadRSSI readRSSI;
@property (nonatomic , copy) XMPeripheralManagerDidUpdateState peripheralUpadte;

@end

@implementation XMBlueToothManager
{
...
+ (XMBlueToothManager *)defaultManager{
    static XMBlueToothManager *manager = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        manager = [[XMBlueToothManager alloc] init];
        [manager initObjects];
    });
